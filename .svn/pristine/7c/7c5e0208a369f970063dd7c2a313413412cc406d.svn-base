...
/**
 * 类名: AESUtil</br> 包名：com.xxx.cts_pwd.utils </br> 描述: </br> 发布版本号：</br> 开发人员：
 * 陈泰山</br> 创建时间： 2014-9-11
 */
...
//		try {
//			String encryptingCode = AESCrypto.encrypt(masterPassword,
//					originalText);
//			// System.out.println("加密结果为 " + encryptingCode);
//			TextView one = (TextView) findViewById(R.id.one);
//			one.setText("加密结果为 " + encryptingCode);
//			String decryptingCode = AESCrypto.decrypt(masterPassword,
//					encryptingCode);
//			TextView two = (TextView) findViewById(R.id.two);
//			two.setText("解密结果为：" + decryptingCode);
